...
import os
token = '7660330149:AAFmdVdq67CEH-bHx9_ImXtx7Dni31xF2rI' #bottoken
bot=telebot.TeleBot(token,parse_mode="HTML")
subscriber = '7221087191'
allowed_users = ['7221087191']  #Your ID
@bot.message_handler(commands=["start"])
def start(message):
    if str(message.chat.id) not in allowed_users:
        bot.reply_to(message, "🚫 𝐘𝐨𝐮 𝐜𝐚𝐧𝐧𝐨𝐭 𝐮𝐬𝐞 𝐭𝐡𝐞 𝐛𝐨𝐭 𝐭𝐨 𝐜𝐨𝐧𝐭𝐚𝐜𝐭 𝐝𝐞𝐯𝐞𝐥𝐨𝐩𝐞𝐫𝐬 𝐭𝐨 𝐩𝐮𝐫𝐜𝐡𝐚𝐬𝐞 𝐚 𝐛𝐨𝐭 𝐬𝐮𝐛𝐬𝐜𝐫𝐢𝐩𝐭𝐢𝐨𝐧 @BLURYCRACKS")
        return
    bot.reply_to(message, "𝐒𝐞𝐧𝐝 𝐭𝐡𝐞 𝐭𝐱𝐭 𝐟𝐢𝐥𝐞 𝐧𝐨𝐰")
@bot.message_handler(commands=["add_user"])
def add_user(message):
    if str(message.chat.id) == '7221087191':  # Only bot owner can add new users
        try:
...
𝐁𝐲 ➜ <a href='t.me/bluryf4ce'>blury</a> ''', reply_markup=mes)
				msg = f'''
...
<a href='t.me/Approved_Raven'>-</a> 𝐁𝐲: <a href='t.me/Approved_Raven'>ׁׅ💤</a> '''
				print(last)
...
<a href='t.me/Approved_Raven'>-</a> 𝐓𝐢𝐦𝐞: <code>{"{:.1f}".format(execution_time)} 𝐬𝐞𝐜𝐨𝐧𝐝 </code>
<a href='t.me/Approved_Raven'>-</a> 𝐁𝐨𝐭 𝐀𝐛𝐨𝐮𝐭: <a href='t.me/Approved_Raven'>⏤͟͞𝑮𝑺𝑰𝑿 𓆩 𝑪𝑯𝑲 𓆪ꪾᶜⁿꪜ</a>
<a href='t.me/Approved_Raven'>-</a> 𝐁𝐲: <a href='t.me/Approved_Raven'>ܻ 』【𝐂𝐇】ᶜⁿꪜ 💤</a> '''
					live += 1
					bot.reply_to(message, msg)
...
𝐁𝐨𝐭 𝐀𝐛𝐨𝐮𝐭: @BLURYCRACKS 
𝐁𝐲: @BLURYCRACKS ''' #Declined
					live += 1
					bot.reply_to(message, msg)
				else:
					dd += 1
